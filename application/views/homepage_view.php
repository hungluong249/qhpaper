				...
				<div class="col-md-12">
					<div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
						...
						<div id="owl-example" class="owl-carousel">
							<div>
								<img class="img-responsive" src="<?php echo site_url('assets/img/') ?>slider/slider-img-1.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo site_url('assets/img/') ?>slider/slider-img-2.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo site_url('assets/img/') ?>slider/slider-img-3.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo site_url('assets/img/') ?>slider/slider-img-4.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="<?php echo site_url('assets/img/') ?>slider/slider-img-1.jpg" alt="">
							</div>
	...
	<section id="about-us">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="block">
						<img class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms" src="<?php echo site_url('assets/img/') ?>cooker-img.png" alt="cooker-img">
					...
					<div class="block">
						...
						<ul>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="300ms">
								<div class="blog-img">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-1.jpg" alt="blog-img">
								</div>
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="400ms">
								<div class="blog-img">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-2.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...</p>
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="500ms">
								...
								<div class="blog-img-2">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-3.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="600ms">
								...
								<div class="blog-img-2">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-4.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="700ms">
								<div class="blog-img">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-5.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...</p>
							...
							<li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="800ms">
								<div class="blog-img">
									<img src="<?php echo site_url('assets/img/') ?>blog/blog-img-6.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...</p>
