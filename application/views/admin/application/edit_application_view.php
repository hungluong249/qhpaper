...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Ứng Dụng
            <small>Cập Nhật tính chất</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Cập nhật tính chất</h3>
                    </div>
                    <!-- /.box-header -->
                    <?php
                    ...
                    <div class="box-body">
                        <div class="form-group col-xs-12">
                            ...
                            ?>
                            <br>
                            <img src="<?php echo base_url('assets/upload/application/' . $detail['image']); ?>" width=150>
                        </div>
                        <div class="form-group col-xs-12">
                            <?php
                        ...
                        <div class="form-group col-md-12">
                            <?php
                            echo form_label('Tên Tính Chất', 'title');
