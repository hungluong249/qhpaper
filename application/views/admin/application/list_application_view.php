...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Ứng Dụng
            <small>Danh sách ứng dụng</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-dashboard"></i> Ứng Dụng</a></li>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Ứng Dụng</h3>
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo base_url('admin/application/create') ?>" class="btn btn-primary" role="button">Thêm Mới</a>
                        </div>
                        <div class="col-md-6">
                            <form action="<?php echo base_url('admin/application/index') ?>" method="get">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($result as $key => $value): ?>
                                        <tr class="remove_<?php echo $value['id'] ?>">
                                            <td><?php echo $i++ ?></td>
                                            <td><img src="<?php echo base_url('assets/upload/application/'. $value['image']) ?>" width="150"></td>
                                            <td><?php echo $value['title'] ?></td>
                                            <td>
                                                <a href="<?php echo base_url('admin/application/edit/' . $value['id']) ?>" id="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                                <a href="javascript:void(0)" class="btn-remove" data-url="<?php echo base_url('admin/application/remove'); ?>" data-id="<?php echo $value['id'] ?>">
