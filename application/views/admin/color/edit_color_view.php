                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-1">
                            <?php
                            echo form_label('Hiển thị');
                            ?>
                            <div style="background-color: <?php echo $detail['hexcolor'] ?>; width: 100%; height: 3em"></div>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_input('hexcolor', $detail['hexcolor'], 'class="form-control my-colorpicker1 colorpicker-element" id="" autocomplete="off" ');
                            ?>
                        </div>
