...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Định Lượng
            <small>Cập nhật định lượng</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Cập nhật định lượng</h3>
                    </div>
                    <!-- /.box-header -->
                    <?php
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            echo form_input('number', $detail['number'], 'class="form-control my-colorpicker1 colorpicker-element" id=""');
                            ?>
                        </div>
                    </div>
                    <!-- /.box-body -->
